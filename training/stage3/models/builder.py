...
def load_stage2_checkpoint(model, checkpoint_path: str) -> Dict[str, Any]:
    ...
    # Filter out vision_encoder keys - vision encoder is frozen and will be initialized fresh
    # This avoids potential architecture mismatches from Stage 2 checkpoint
