    ...
    def forward(self, 
        ...
        Đầu vào:
            ...
            - boxes_list (list[torch.Tensor]): Một list (độ dài B)
              ...
              LƯU Ý: Tọa độ này là tọa độ GỐC (pixel)
        ...
        for i in range(B):
            ...
            # Chuẩn hóa về [0, 1]
            norm_boxes_min_xyz = boxes_min_xyz / orig_dims_tensor # [num_rois, 3]
            norm_boxes_max_xyz = boxes_max_xyz / orig_dims_tensor # [num_rois, 3]
