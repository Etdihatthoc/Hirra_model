...
class LanguageDecoder(nn.Module):
    def __init__(
        ...
        *,
        ...
        """
        Mục đích: Tải và chứa lõi LLM (Qwen-2.5-3B-Instruct) từ Hugging Face.
                  Cung cấp các hàm tiện ích.

        Model info:
            - Qwen2.5-3B-Instruct: 3B parameters, hidden_size=2048
            - Smaller and faster than 7B version
        ...
        special_tokens = ["<ROI_VISUALS>", "<GLOBAL_VISUALS>"]
