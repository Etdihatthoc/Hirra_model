...
class ROIPairGraphBuilder(nn.Module):
    ...
    def compute_spatial_relations(
        ...
        # Same anatomical region (based on z-coordinate ranges)
        # Regions: [0-50]: head/neck, [51-100]: chest, [101-150]: abdomen, [151-200]: pelvis
        regions = (centers[:, 0] / 50).long()  # [N]
    ...
    def forward(
        ...
        # 3. Compute intensity relationships
        intensity_encoded = self.compute_intensity_relations(roi_boxes, ct_image, pet_image)
